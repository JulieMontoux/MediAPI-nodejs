...
exports.createAuthor = async ({ nom, prenom, annee_naissance }) => {
  const [authorId] = await db("auteurs")
    .insert({ nom, prenom, annee_naissance })
    .returning("id");
  return authorId;
};

// PUT
exports.updateAuthor = async (
  id,
...
exports.deleteAuthor = async (id) => {
  ...
  if (livres.length > 0) {
    throw new Error(
      "Impossible de supprimer l'auteur car il est associé à un ou plusieurs livres"
    );
  }
